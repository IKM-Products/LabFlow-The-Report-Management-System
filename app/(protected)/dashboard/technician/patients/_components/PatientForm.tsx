          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <Input {...register("mrn")} disabled={isSubmitting} className="rounded-xl border-slate-200 font-mono" />
                {errors.mrn && <p className="text-[10px] text-red-500 font-medium">{errors.mrn.message}</p>}
              </div>
              <div className="space-y-1">
                <Label className="text-xs font-semibold text-slate-700">Date of Birth</Label>
                <Input type="date" {...register("dob")} disabled={isSubmitting} className="rounded-xl border-slate-200" />
