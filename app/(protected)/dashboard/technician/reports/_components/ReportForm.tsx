    ...
    <>
      {showTrigger && !isControlled && (
        <Button
          ...
          className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium shadow-xs text-sm h-10 px-4 transition-colors cursor-pointer inline-flex items-center justify-center"
        >
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full h-9 px-3 text-xs bg-white border border-slate-200 rounded-xl focus:outline-hidden focus:ring-1 focus:ring-emerald-500 font-medium text-slate-600 disabled:opacity-50 cursor-pointer"
                >
                  <option value="">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full h-9 px-3 text-xs bg-white border border-slate-200 rounded-xl focus:outline-hidden focus:ring-1 focus:ring-blue-500 font-medium text-slate-800 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                >
                  <option value="">
                    {!selectedPatientId
